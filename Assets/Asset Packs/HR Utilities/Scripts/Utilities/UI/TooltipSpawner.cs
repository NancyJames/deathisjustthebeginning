...
{
    public abstract class TooltipSpawner : MonoBehaviour, IPointerEnterHandler, IPointerExitHandler, ISelectHandler, IDeselectHandler
    {
        // CONFIG DATA
        ...
        /// <summary>
        /// Return true when the tooltip spawner should be allowed to create a tooltip. eg. an empty inventory slot would not create a tooltip
        /// </summary>
